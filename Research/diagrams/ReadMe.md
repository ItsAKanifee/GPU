...
3. Create a short Markdown file with the same base name to record metadata and a short description, e.g. `sm-pipeline.md`:
...
4. If the diagram came from an external source, include the URL and any required attribution in the Markdown file.
